...
import "./AboutMe.css";
import profilePic from "../../Images/gias.jpg";
            ...
            <div className="col-md-6 col-lg-6 col-sm-12">
              ...
              <div className="about ">
                ...
                <p className="mt-2 paragrap" style={styles.slideInRight}>
                  ...
                  and MySQL but basically a MERN Stack developer.
                </p>
              </div>
              ...
              <div className="w-full m-auto row">
                <div className="col-md-6 col-sm-12">
                  {/* <button className="btn btn-info mt-3">Hire Me</button> */}
                </div>
                <div className="col-md-6 col-sm-12 mb-">
                  <button className="btn btn-info mt-3 resume-download">
                    <a className=""
                      href="https://drive.google.com/file/d/1QkIP-lXFn-faKqUnNw9ckepUd0z2iY5f/&export=download"
                      download
                    >
                      Download Resume
                    </a>
